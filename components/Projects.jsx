    ...
    <div className='w-full'>
        <div className='max-w-[1240px] mx-auto px-2 py-16'>
            ...
            <div className='grid md:grid-cols-2 gap-8'>
                <div className='relative flex itmes-center justify-center h-auto w-auto shadow-xl shadow-gray-500 rounded-xl p-4 group hover:bg-gradient-to-r from-[#3c8475] to-[#b15ac8]'>
